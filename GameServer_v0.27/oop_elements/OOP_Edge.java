...
public class OOP_Edge implements oop_edge_data, Serializable
{
    private int _src;
    private int _dest;
    private String _key;
    ...
    static {
        OOP_Edge.DEFAULT_WEIGHT = 1.0;
    }
    
    public OOP_Edge(final int src, final int dest) {
        this(src, dest, OOP_Edge.DEFAULT_WEIGHT);
    }
    
    public OOP_Edge(final int src, final int dest, final double w) {
        this.set_src(src);
        this.set_dest(dest);
        this.set_weight(w);
    }
    
    public oop_edge_data init(final int src, final int dest, final double w) {
        return new OOP_Edge(src, dest, w);
    }
